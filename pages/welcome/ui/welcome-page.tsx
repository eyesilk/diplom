...
function formatWelcomeDate(value: string) {
...
export default function WelcomePage() {
  ...
  const { width, isCompact, isTablet, isLargeScreen } = useResponsiveLayout();
  ...
  const sliderWidth = width - screenPadding * 2;
  const heroTitleSize = isLargeScreen ? 76 : isTablet ? 60 : isCompact ? 38 : 46;
  const subtitleSize = isLargeScreen ? 22 : isTablet ? 18 : 16;
  const slideHeight = isCompact ? 220 : 260;
  const sliderMinHeight = slideHeight + 18;
  const shouldStackFeatureCards = isCompact;

  const { data, isLoading } = useQuery({
    queryKey: ["welcome-slider", "popular"],
    queryFn: () => fetchMovieTrailersCollection("popular", 1, 5),
  });
  ...
  const renderSlide = ({ item }: { item: TrailerItem }) => (
    ...
    >
      <ImageBackground
        ...
        style={[styles.slideImage, { minHeight: slideHeight }]}
        ...
        <View style={styles.slideContent}>
          ...
          <Text
            style={[
              styles.slideTitle,
              {
                fontSize: isTablet ? 32 : isCompact ? 22 : 28,
                lineHeight: isTablet ? 38 : isCompact ? 28 : 34,
              },
            ]}
          >
            {item.title}
          ...
          <View style={styles.slideMetaRow}>
            ...
            <View style={styles.slideMetaPill}>
              <Ionicons name="calendar-outline" size={14} color="#d6e2ee" />
              <Text style={styles.slideMetaText}>
                {formatWelcomeDate(item.releaseDate)}
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={styles.hero}>
              ...
              >
                {slides.length > 0 ? (
                  ...
                  <View style={[styles.sliderFallback, { minHeight: sliderMinHeight }]}>
                    {isLoading ? (
                      <>
            ...
            <View style={styles.bottomArea}>
              ...
              <View
                style={[
                  styles.featureGrid,
                  shouldStackFeatureCards && styles.featureGridStacked,
                ]}
              >
                {[
                  {
                  ...
                  <View
                    ...
                    style={[
                      ...
                      shouldStackFeatureCards && styles.featureCardStacked,
                    ]}
                  >
                    <Ionicons
